...
import com.ft.export.dto.ExportFieldDetail;
import com.ft.export.dto.ExportFieldDto;
...
public class ExcelUtil {
	...
	private static Map<String, ExportFieldDto> getExportFieldDtoMap(Class clazz, List<String> colList) throws Exception{
		Map<String, ExportFieldDto> resultMap = new HashMap<>();
	...
	public static <T>Workbook outputExcelResult4(int sheetNo, String sheetName, List<String> colName, List<String> colProperty,
		...
		try {
			...
			Map<String, ExportFieldDto> fieldDtoMap = null;
			try {
			...
			ExportFieldDetail exportFieldDetail = new ExportFieldDetail();
	...
	/**
		填充数据
	 **/
	private static <T>Workbook fillDataPro(Workbook workbook, int sheetNo, List<T> dataList, List<String> colProperty, Map<String, ExportFieldDto> fieldDtoMap, ExportFieldDetail exportFieldDetail) {
